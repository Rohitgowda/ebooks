			...
			<h2>Welcome to Sterling Library<img src="images/hand.png" height="27px"></img></h2>
			  ...
			  <%
					...
					if(session.getAttribute("username")==null)
					{
						    	...
						    	String strQuery = "select * from sl_bookmaster where cat_name='Training'";
					...
					else
					{
						...
						<form name="form" action="Training.jsp" method="post" >
						<table class="book_tabel">
							<%
								try{      
						  ...
						  <% 	} %>
								...
								<td  width="300px" height="300px" align="center">
					    			<img src="ImageRetrieve?imgid=<%=rs1.getInt("book_id")%>" width="150x" height="150px" />
						    			...
						    			<p align="left" style="color:blue;margin-left:60px;">Book Name: <span style="color:black"><%=rs1.getString("book_name") %></span></p>
						       
						       			<p align="left" style="color:blue;margin-left:60px;">Category: <span style="color:black"><%=rs1.getString("cat_name") %></span></p>
						       			
										<p align="left" style="color:blue;margin-left:60px;">Author: <span style="color:black"><%=rs1.getString("book_author") %></span></p>
							   					
							   			<p align="left" style="color:blue;margin-left:60px;">Price: <span style="color:black"><%=rs1.getString("book_price") %></span></p>
