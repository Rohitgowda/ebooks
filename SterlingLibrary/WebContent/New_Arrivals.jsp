		...
		<form name="form" action="Login.jsp" method="post" >
				<table align="center">
							<%
							    ...
							    String strQuery = "select * from sl_bookmaster order by book_id desc";
					...
					%>
						...
						<%
		    			    ...
		    			    String strQuery = "select * from sl_bookmaster group by book_id desc";
								...
								<td  width="350px" height="300px" align="center">
					    			<div style="border:solid 2px #dedede;">
										...
										<p align="left" class="para">Author: <span style="color:green"><%=rs2.getString("book_author") %></span></p>
						      			...
						      			<a href="#" onclick="window.open('PdfRetrieve?pdid=<%=rs2.getInt("book_id")%>','_blank')">Pdf format</a><br>
						      			
						      			
					      				<%-- <input type="button" value="Detail" class="tableSubmitUpdatebutton" onclick="window.open('PdfRetrieve?pdid=<%=rs2.getInt("book_id")%>','_blank')"/> --%>
