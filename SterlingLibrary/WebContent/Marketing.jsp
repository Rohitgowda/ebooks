			...
			<h2>Welcome to Sterling Library<img src="images/hand.png" height="27px"></img></h2>
			  ...
			  <%
					...
					if(session.getAttribute("username")==null)
					{
						    	...
						    	String strQuery = "select * from sl_bookmaster where cat_name='Marketing'";
					...
					else
					{
						...
						<form name="form" action="Marketing.jsp" method="post" >
						<table class="book_tabel">
							<%
								try{      
						  ...
						  <% 	} %>
								...
								<td  width="300px" height="300px" align="center">
						    			...
						    			<p align="left" class="para">Name: <span style="color:black"><%=rs1.getString("book_name") %></span></p>
